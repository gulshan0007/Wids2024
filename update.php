...
//echo "hello";
  ...
  <div class="container">
    <div class="page-header">
      <h1>Update Choice | <a href="index.php">SURP</a><small> Summer Undergraduate Research Program</small>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logout.php">Logout</a></h1>
    </div>
    <a href="mychoice.php"class="btn btn-info" role="button">MyChoice</a>
  </div>
  <div class="wrapper">
  <?php
// session_start();
...
?>
    ...
    <form class="form-register" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
      ...
      <label class="form-control">Full Name *
        <input type="text" class="form-control" style="font-weight:normal;" name="fullname" readonly placeholder="Update this on SSO and relogin" required autofocus="" value='<?php echo $_SESSION['fullname']; ?>' />
      </label>

      <label class="form-control">Roll Number *
        <input type="text" class="form-control" name="roll" style="font-weight:normal;" readonly placeholder="Enter Your IITB Roll Number" required autofocus="" value='<?php echo $_SESSION['roll']; ?>'/>
      </label>
      ...
      <label class="form-control">Alternate Email
        <input type="email" class="form-control" name="altemail" style="font-weight:normal;" placeholder="Enter Your Alternate Email if any" autofocus="" value='<?php echo $_SESSION['altemail']; ?>' />
      </label>
...
<input  type="text" class="form-control" name="hostel" style="font-weight:normal;" placeholder="Enter Your Hostel Number" required autofocus="" />
      ...
      <label class="form-control">Asc Portal Screen *(This is to check your CPI)
        <input type="url" class="form-control" name="ssasc" style="font-weight:normal;" placeholder="Link of ScreenShot of Asc Portal" required autofocus="" value='<?php echo $_SESSION['SS_Asc']; ?>' />
      </label>
...
<input type="text" class="form-control" name="mobile" style="font-weight:normal;" placeholder="Please enter your mobile number"  autofocus="" required value ='<?php echo $_SESSION['mobile']; ?>'/>
      ...
      <label class="form-control">CPI*
        <input type="text" class="form-control" name="cpi" readonly placeholder="Enter your CPI" required style="font-weight:normal;" autofocus="" value='<?php echo $_SESSION['cpi']; ?>'/>
        <!-- <?php
//               if ($year_of_study == 1) {
//                 echo '
...
//               }
      ...
      <label class="form-control">Preference 1* (Enter Project ID)
        <input type="number" class="form-control" min="2101" max="2257" name="PreferenceID1" placeholder="Project ID 1" required="" style="font-weight:normal;" autofocus="" value='<?php echo $_SESSION['PreferenceID1']; ?>'/> <br>
...
<input type="text" class="form-control" name="ProjectTitle1" placeholder="Title of Project 1" required=""style="font-weight:normal;" autofocus="" value ='<?php echo $_SESSION['PTitle1']; ?>' /> -->
        <input type="url" class="form-control" name="SOP1" placeholder="Enter Link of SoP 1" required="" style="font-weight:normal;" autofocus="" value='<?php echo $_SESSION['SOP1']; ?>' />
      </label>

      <label class="form-control">Preference 2 (Enter Project ID)
        <input type="number" class="form-control" min="2101" max="2257" name="PreferenceID2" placeholder="Project ID 2" style="font-weight:normal;" autofocus="" value='<?php echo $_SESSION['PreferenceID2']; ?>'/> <br>
...
<input type="text" class="form-control" name="ProjectTitle2" placeholder="Title of Project 2" style="font-weight:normal;" autofocus="" value ='<?php echo $_SESSION['PTitle2']; ?>' /> -->
        <input type="url" class="form-control" name="SOP2" placeholder="Enter Link of SoP 2" style="font-weight:normal;" autofocus="" value='<?php echo $_SESSION['SOP2']; ?>'/>
      </label>

      <label class="form-control">Preference 3 (Enter Project ID)
        <input type="number" class="form-control" min="2101" max="2257" name="PreferenceID3" placeholder="Project ID 3" style="font-weight:normal;" autofocus="" value='<?php echo $_SESSION['PreferenceID3']; ?>'/> <br>
...
<input type="text" class="form-control" name="ProjectTitle3" placeholder="Title of Project 3" style="font-weight:normal;" autofocus="" value ='<?php echo $_SESSION['PTitle3']; ?>' /> -->
        <input type="url" class="form-control" name="SOP3" placeholder="Enter Link of SoP 3" style="font-weight:normal;" autofocus="" value='<?php echo $_SESSION['SOP3']; ?>'/>
      </label>
