...
$info="<strong>Prof Name:</strong> ".$results["prof_name"]."<br/><br/>"."<strong>Project Title:</strong> ".$results["project_title"]."<br/><br/><strong>Project Description:</strong> ".$results["project_description"]."<br/><br/><strong>Eligibility Criteria:</strong> ".$results["eligibility"]."<br/><br/><strong>Other Prerequisites:</strong> ".$results["other_prereq"]."<br/><br/><strong>Students Required:</strong> ".$results["students_req"]."<br/><br/><strong>minimum years:</strong> ".$results["year"]."<br/><br/><strong>Duration:</strong> ".$results["duration"]."<br/><br/><strong>What To Learn:</strong> ".$results["what_to_learn"]."<br/><br/><a  href='#' onClick='parent.jQuery.fancybox.close();'>Close This Window</a>";
mysqli_close($link);
echo $info;
