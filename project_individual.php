    ...
    <section id="course-details" class="course-details" style="padding-bottom: 0px !important;">
        <div class="container p-5" data-aos="fade-up">
            ...
            <footer class="bg-light py-4 mt-5 w-90 flex-shrink-0 my-5 "
                style="background: #eee !important; width: 100%; margin-top: 40px; margin: auto; " id="temp">
                <div class="container py-4" style="padding-bottom: 0px !important; max-width: 1400px; "
                    data-aos="zoom-in">
