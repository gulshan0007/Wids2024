<?php
  session_start();
//   $_SESSION['ldap'] = '210040038@iitb.ac.in';
//   $_SESSION['name'] = 'Challa Rupak Vardhan';
//   $_SESSION['rollno'] = '210040038';
//   $_SESSION['email'] = '210040038@iitb.ac.in'; 
//   $_SESSION['gmail'] = 'challajyothi05@gmail.com'; 
//   $_SESSION['phno'] = '8639506480';
...
//   if ($logged_in && (!isset($_SESSION['gmail']) || (strlen($_SESSION['phno']) <= 0))){
//   	header("Location: fill_details.php");
//   	exit();
//     /* echo '<script type="text/javascript">
//             window.onload = function () { alert("You have not added your gmail ID. Please go to https://gymkhana.iitb.ac.in/profiles/user/ and fill up the details, and re-login"); }
//           </script>'; */
//   }
?>
...
<link href="https://fonts.googleapis.com/css2?family=Borel&family=Cabin+Sketch:wght@700&family=Rubik+Moonrocks&family=Rye&display=swap" rel="stylesheet">
    <style>
...
.typewriter {
    ...
    .show {
      opacity: 1; /* Show the counter when this class is applied */
    }
...
<div class="modal" tabindex="-1" role="dialog" id="myModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <div class="modal-title">
            <h5>Important Announcement! <img src="assets/img/logo/loudspeaker-icon.svg" style="float:right;height:5%;width:5%;"></h5>    
        </div>
    ...
    <header>
        <div class="container">
            <div class="row">
                ...
                <?php if ($logged_in){ ?>
                <h3 class="section-heading" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">Hello <?php echo $_SESSION['name']; ?>, Welcome to </h3>
                <h1 class="section-heading" style="font-family: 'Cabin Sketch', sans-serif; font-size: 70px;" id="dynamicText"></h1>
                <?php }else{ ?>
                    <h3 class="section-heading" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">Hello Guest, Welcome to </h3>
    
                <h1 class="section-heading" style="font-family: 'Cabin Sketch', sans-serif; font-size: 70px;" id="dynamicText"></h1>
                <h4 class="section-heading" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">Please Login via SSO to continue </h4>
                <?php }?> 
                    <!--<h2 class="section-heading" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">WiDS</h2>-->
...
<section id="portfolio" class="bg-light-gray" style="background-color: white;">
        <div class="container" data-aos="zoom-in">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;"> TOTAL PROJECTS</h2>
                    <h3 class="section-subheading text-muted" style="font-family: 'Questrial', sans-serif;">Projects from different fields</h3>
                </div>
            </div>
    ...
    <section id="about" style="background-color:#fff;">
        <div class="container" data-aos="slide-up">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">WHAT IS WiDS ?</h2>
                    <h3 class="section-subheading text-muted"></h3>
                </div>
            </div>
            <div class="row">
                <p style="font-size: 20px;font-family: 'Questrial', sans-serif;" class="text-muted">
                    Winter in Data Science is your ultimate destination for comprehensive learning, exploration, and hands-on application in the realm of AI and ML-driven Data Analytics. Immerse yourself in the ML world through an extensive two-week boot camp and a user-friendly ML booklet that covers everything from Python basics to a sufficient grasp of Deep Learning. Following this boot camp, you can delve into a multitude of PROJECTS offered by the Analytics Club.
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-timeline">
                        <div class="timeline" data-aos="slide-up">
                            <div class="timeline-content">
                                <div class="circle"><span class="homebox">
                                  <img src="img/wids_projects/stage_1.jpeg" style="width:100%; height:100%" class="img">
                                 </span></div>
                                <div class="content">
                                    <span class="year">Stage 1</span>
                                    <br>
                                    <p class="description">
                                        Application for projects. Please fill in your general motivation to apply and your previous work experience in the application form.
                                        <br>
                        ...
                        <div class="timeline" data-aos="slide-up">
                            <div class="timeline-content">
                                <div class="circle"><span class="homebox"><img src="img/wids_projects/stage_2.jpg" style="width:100%; height:100%" class="img" /></span></div>
                                <div class="content">
                                    <span class="year">Stage 2</span>
                                    <br>
                                    <p class="description">
                                        Assignment and SOP shortlisting by WiDS team. This will help the mentors of WiDS gauge whether a student is really driven and will see the project through. Only one project will be allocated per student.
                                        <br>
                        ...
                        <div class="timeline" data-aos="slide-up">
                            <div class="timeline-content">
                                <div class="circle"><span class="homebox"><img src="img/wids_projects/stage_3.jpg" style="width:100%; height:100%" class="img"></span></div>
                                <div class="content">
                                    <span class="year">Stage 3</span>
                                    <br>
                                    <p class="description">
                                        Mentors will guide the mentees on material to refer and a tentative action plan. Mentor feedback forms will be released towards the end of December.
                                        <br>
   ...
   <section id="about" style="background-color:#fff;">
            <div class="container" data-aos="slide-up">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h2 class="section-heading" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">WHY WiDS ?</h2>
                        <h3 class="section-subheading text-muted"></h3>
                    </div>
                </div>
                <div class="row">
                        ...
                        <ul class="timeline">
                            <li class="timeline-inverted" data-aos="slide-left">
                                <div class="timeline-image">
                                    <img class="img-circle img-responsive" src="img/about/expolre doamins new-01.jpg" alt="">
                                </div>
                                <div class="timeline-panel"  >
                                    <div class="timeline-heading">
                                        <!-- <h4>March 2011</h4> -->
                                        <h4 class="subheading" style="font-family: 'Questrial', sans-serif;font-size:25px;">Hands-on Learning</h4>
                                    </div>
                                    <div class="timeline-body">
                                        <p class="text-muted" style="font-family: 'Questrial', sans-serif;font-size:18px;">You can gain practical experience by working on your choice of projects.</p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li data-aos="slide-right">
                                ...
                                <div class="timeline-panel">
                                    ...
                                    <div class="timeline-heading">
                                        <!-- <h4>December 2012</h4> -->
                                        <h4 class="subheading" style="font-family: 'Questrial', sans-serif;font-size:25px;">Make use of free time</h4>
                                    </div>
                                    <div class="timeline-body">
                                        <p class="text-muted" style="font-family: 'Questrial', sans-serif;font-size:18px;">Utilize your winter season to delve deeply into the Data Science topic of your choice.</p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="timeline-inverted" data-aos="slide-left">
                                <div class="timeline-image">
                                    <img class="img-circle img-responsive" src="img/about/research under prof-01.jpg" alt="">
                                </div>
                                <div class="timeline-panel">
                                    <br>
                                    <div class="timeline-heading">
                                        <!-- <h4>July 2014</h4> -->
                                        <h4 class="subheading" style="font-family: 'Questrial', sans-serif;font-size:25px;">Develop connections</h4>
                                    </div>
                                    <div class="timeline-body">
                                        <p class="text-muted" style="font-family: 'Questrial', sans-serif;font-size:18px;">Find a community of similar minded people and network with people having a passion for Data Science..</p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="timeline-image" data-aos="slide-right">
                                ...
                                <div class="timeline-panel">
                                    ...
                                    <div class="timeline-heading">
                                        <!-- <h4>July 2014</h4> -->
                                        <h4 class="subheading" style="font-family: 'Questrial', sans-serif;font-size:25px;">Immersive bootcamp and Comprehensive ML booklet</h4>
                                    </div>
                                    <div class="timeline-body">
                                        <p class="text-muted" style="font-family: 'Questrial', sans-serif;font-size:18px;">The two-week boot camp covers Python basics and Deep Learning, providing a strong foundation.</p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="timeline-inverted" data-aos="slide-left">
                                ...
                                <div class="timeline-panel">
                                    ...
                                    <div class="timeline-heading">
                                        <!-- <h4>July 2014</h4> -->
                                        <h4 class="subheading" style="font-family: 'Questrial', sans-serif;font-size:25px;">
                                            Get certified
                                            </h4>
                                    </div>
                                    <div class="timeline-body">
                                        <p class="text-muted" style="font-family: 'Questrial', sans-serif;font-size:18px;"> Receive a certificate recognizing your active participation and achievements in the program</p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="timeline-image" data-aos="slide-right">
                                ...
                                <div class="timeline-panel">
                                    ...
                                    <div class="timeline-body">
                                        <p class="text-muted" style="font-family: 'Questrial', sans-serif;font-size:18px;">We have projects that have applications in finance, gaming, quantum ML and may more!</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
    ...
    <section id="portfolio" class="bg-light-gray" style="background-color: white;">
        <div class="container" data-aos="zoom-in">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">PROJECTS</h2>
                    <h3 class="section-subheading text-muted" style="font-family: 'Questrial', sans-serif;">Projects from different departments</h3>
                </div>
            </div>
            <div class="row" style="text-align:center;">
                <!--<h2 class="section-heading">Coming Soon!</h2>-->
                <div class="row text-center">
                    <a align="center"  href="browse.php" class="page-scroll btn btn-xl" style="background-color:#323B75;color:white; border-color:white;">
                        All Projects
                    </a>
          ...
          " class="text-center" data-aos="zoom-in">
            ...
            <div class="faq-cell" data-aos="fade-in">
                <div class="question text-center">
                    <b>
                        How many projects can I apply for? Will I be able to update my choices after choosing the projects once?
                        </b>
                    <span class="ext">+</span>
                </div>
                <div class="answer">
                    <hr />
                    <p>
                        You can specify your project preferences, and based on your choices, you will be assigned one project. Update your choices by the following steps:


            </p>
                    <ul>
                        <li>
                            Go to the WiDS Portal and click on Login via SSO and then after logging in, click on the APPLY NOW tab in the top right corner.
            ...
            <div class="faq-cell" data-aos="fade-in">
                ...
                <div class="answer">
                    <hr />
                    <p>
                        Statement of Purpose should reflect the motivation with which you are filling the application for the project you wish to do. It is used by the mentor to judge if you are enthusiastic enough to learn and work on the project. Please write a separate SOP directed towards each project in case you’re applying for multiple projects.
            ...
            <div class="faq-cell" data-aos="fade-in">
                ...
                <div class="answer">
                    ...
                    <p>
                        ...
                        The duration mentioned on the projects is tentatively a month. Starting in the 1st week of December 2024 and ending in 1st week of January 2025.
            ...
            <div class="faq-cell" data-aos="fade-in">
                ...
                <div class="answer">
                    <hr />
                    <p>
                        Yes, wherever mentioned the assignment is mandatory and an important selection criteria while selecting students for WiDS 2024. 
            ...
            <div class="faq-cell" data-aos="fade-in">
                ...
                <div class="answer">
                    <hr />
                    <p>
                        Any student who fails to perform satisfactorily in the project and/or leaves the project will not receive any certification for the program.
            ...
            <div class="faq-cell" data-aos="fade-in">
                ...
                <div class="answer">
                    <hr />
                    <p>
                        The applicants will receive the link to the WiDS 2024 dashboard where the selection status for each project will be updated regularly. The applicants will receive the link to the dashboard via email.
                    </p>
                </div>
            </div>
            ...
            <div class="faq-cell" data-aos="fade-in">
                ...
                <div class="answer">
                    <hr />
                    <p>
                        Please contact Manager Analytics Club or any of the WiDS team members whose details you can find on the contact tab on the top right corner.
                    </p>
                </div>
            </div>
