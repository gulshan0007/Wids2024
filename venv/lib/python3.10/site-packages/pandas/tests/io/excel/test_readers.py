...
class TestReaders:
    ...
    def test_usecols_int(self, read_ext):
        ...
        with pytest.raises(ValueError, match=msg):
            pd.read_excel(
                "test1" + read_ext, sheet_name="proj_info", index_col=0, usecols=3
            )
    ...
    def test_usecols_list(self, request, read_ext, df_ref):
        ...
        df1 = pd.read_excel(
            "test1" + read_ext, sheet_name="proj_info", index_col=0, usecols=[0, 2, 3]
        )
        df2 = pd.read_excel(
            "test1" + read_ext,
            sheet_name="proj_info",
    ...
    def test_usecols_str(self, request, read_ext, df_ref):
        ...
        df2 = pd.read_excel(
            "test1" + read_ext, sheet_name="proj_info", index_col=0, usecols="A:D"
        )
        df3 = pd.read_excel(
            "test1" + read_ext,
            sheet_name="proj_info",
        ...
        df2 = pd.read_excel(
            "test1" + read_ext, sheet_name="proj_info", index_col=0, usecols="A,C,D"
        )
        df3 = pd.read_excel(
            "test1" + read_ext,
            sheet_name="proj_info",
    ...
    def test_usecols_diff_positional_int_columns_order(
        ...
        result = pd.read_excel(
            "test1" + read_ext, sheet_name="proj_info", index_col=0, usecols=usecols
        )
    ...
    def test_usecols_diff_positional_str_columns_order(self, read_ext, usecols, df_ref):
        ...
        result = pd.read_excel("test1" + read_ext, sheet_name="proj_info", usecols=usecols)
        tm.assert_frame_equal(result, expected, check_names=False)
    ...
    def test_read_excel_without_slicing(self, request, read_ext, df_ref):
        ...
        expected = df_ref
        result = pd.read_excel("test1" + read_ext, sheet_name="proj_info", index_col=0)
        tm.assert_frame_equal(result, expected, check_names=False)
    ...
    def test_usecols_excel_range_str(self, request, read_ext, df_ref):
        ...
        expected = df_ref[["C", "D"]]
        result = pd.read_excel(
            "test1" + read_ext, sheet_name="proj_info", index_col=0, usecols="A,D:E"
        )
        tm.assert_frame_equal(result, expected, check_names=False)
    ...
    def test_usecols_excel_range_str_invalid(self, read_ext):
        ...
        with pytest.raises(ValueError, match=msg):
            pd.read_excel("test1" + read_ext, sheet_name="proj_info", usecols="D:E1")
    ...
    def test_excel_stop_iterator(self, read_ext):
        parsed = pd.read_excel("test2" + read_ext, sheet_name="proj_info")
    ...
    def test_excel_cell_error_na(self, request, read_ext):
        ...
        parsed = pd.read_excel("test3" + read_ext, sheet_name="proj_info")
    ...
    def test_excel_table(self, request, read_ext, df_ref):
        ...
        df1 = pd.read_excel("test1" + read_ext, sheet_name="proj_info", index_col=0)
        df2 = pd.read_excel(
            "test1" + read_ext, sheet_name="proj_info", skiprows=[1], index_col=0
        )
        ...
        df3 = pd.read_excel(
            "test1" + read_ext, sheet_name="proj_info", index_col=0, skipfooter=1
        )
    ...
    def test_reader_special_dtypes(self, request, read_ext):
        ...
        actual = pd.read_excel(basename + read_ext, sheet_name="proj_info")
        ...
        for icol, name in enumerate(expected.columns):
            actual = pd.read_excel(
                basename + read_ext, sheet_name="proj_info", index_col=icol
            )
        ...
        actual = pd.read_excel(
            basename + read_ext, sheet_name="proj_info", converters={"StrCol": str}
        )
        tm.assert_frame_equal(actual, expected)
    ...
    def test_reader_converters(self, read_ext):
        ...
        # dtypes)
        actual = pd.read_excel(
            basename + read_ext, sheet_name="proj_info", converters=converters
        )
        tm.assert_frame_equal(actual, expected)
    ...
    def test_reading_all_sheets_with_blank(self, read_ext):
        ...
        dfs = pd.read_excel(basename + read_ext, sheet_name=None)
        expected_keys = ["proj_info", "proj_info", "Sheet3"]
        tm.assert_contains_all(expected_keys, dfs.keys())

    # GH6403
    def test_read_excel_blank(self, read_ext):
        actual = pd.read_excel("blank" + read_ext, sheet_name="proj_info")
        tm.assert_frame_equal(actual, DataFrame())

    def test_read_excel_blank_with_header(self, read_ext):
        expected = DataFrame(columns=["col_1", "col_2"])
        actual = pd.read_excel("blank_with_header" + read_ext, sheet_name="proj_info")
        tm.assert_frame_equal(actual, expected)

    def test_exception_message_includes_sheet_name(self, read_ext):
        # GH 48706
        with pytest.raises(ValueError, match=r" \(sheet: proj_info\)$"):
            pd.read_excel("blank_with_header" + read_ext, header=[1], sheet_name=None)
        with pytest.raises(ZeroDivisionError, match=r" \(sheet: proj_info\)$"):
    ...
    def test_excel_read_buffer(self, read_ext):
        pth = "test1" + read_ext
        expected = pd.read_excel(pth, sheet_name="proj_info", index_col=0)
        with open(pth, "rb") as f:
            actual = pd.read_excel(f, sheet_name="proj_info", index_col=0)
    ...
    @pytest.mark.parametrize(
        "sheet_name",
        [3, [0, 3], [3, 0], "Sheet4", ["proj_info", "Sheet4"], ["Sheet4", "proj_info"]],
    )
    ...
    def test_read_from_pathlib_path(self, read_ext):
        ...
        expected = pd.read_excel(str_path, sheet_name="proj_info", index_col=0)

        path_obj = Path("test1" + read_ext)
        actual = pd.read_excel(path_obj, sheet_name="proj_info", index_col=0)
    ...
    def test_close_from_py_localpath(self, read_ext):
        ...
        with open(str_path, "rb") as f:
            x = pd.read_excel(f, sheet_name="proj_info", index_col=0)
            del x
    ...
    def test_reader_seconds(self, request, engine, read_ext):
        ...
        actual = pd.read_excel("times_1900" + read_ext, sheet_name="proj_info")
        tm.assert_frame_equal(actual, expected)

        actual = pd.read_excel("times_1904" + read_ext, sheet_name="proj_info")
        tm.assert_frame_equal(actual, expected)
    ...
    def test_deprecated_kwargs(self, read_ext):
        with pytest.raises(TypeError, match="but 3 positional arguments"):
            pd.read_excel("test1" + read_ext, "proj_info", 0)
...
class TestExcelFileRead:
    ...
    def test_excel_passes_na(self, read_ext):
        with pd.ExcelFile("test4" + read_ext) as excel:
            parsed = pd.read_excel(
                excel, sheet_name="proj_info", keep_default_na=False, na_values=["apple"]
            )
        expected = DataFrame(
        ...
        with pd.ExcelFile("test4" + read_ext) as excel:
            parsed = pd.read_excel(
                excel, sheet_name="proj_info", keep_default_na=True, na_values=["apple"]
            )
        expected = DataFrame(
    ...
    def test_excel_read_buffer(self, engine, read_ext):
        pth = "test1" + read_ext
        expected = pd.read_excel(pth, sheet_name="proj_info", index_col=0, engine=engine)

        with open(pth, "rb") as f:
            with pd.ExcelFile(f) as xls:
                actual = pd.read_excel(xls, sheet_name="proj_info", index_col=0)
    ...
    def test_reader_closes_file(self, engine, read_ext):
        with open("test1" + read_ext, "rb") as f:
            with pd.ExcelFile(f) as xlsx:
                # parses okay
                pd.read_excel(xlsx, sheet_name="proj_info", index_col=0, engine=engine)
    ...
    def test_header_with_index_col(self, filename):
        ...
        result = pd.read_excel(
            filename, sheet_name="proj_info", index_col=0, header=[0, 1]
        )
        tm.assert_frame_equal(expected, result)
    ...
    def test_ignore_chartsheets(self, request, engine, read_ext):
        ...
        with pd.ExcelFile("chartsheet" + read_ext) as excel:
            assert excel.sheet_names == ["proj_info"]
