...
class TestExcelWriter:
    ...
    def test_datetimes(self, path):
        ...
        write_frame.to_excel(path, "proj_info")
        read_frame = pd.read_excel(path, sheet_name="proj_info", header=0)
    ...
    def test_write_lists_dict(self, path):
        ...
        df.to_excel(path, "proj_info")
        read = pd.read_excel(path, sheet_name="proj_info", header=0, index_col=0)
    ...
    def test_render_as_column_name(self, path):
        ...
        df.to_excel(path, "proj_info")
        read = pd.read_excel(path, "proj_info", index_col=0)
        expected = df
        tm.assert_frame_equal(read, expected)
    ...
    def test_freeze_panes(self, path):
        ...
        expected.to_excel(path, "proj_info", freeze_panes=(1, 1))
