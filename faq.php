...
<section id="contact">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <h2 class="section-heading" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;"> Have Queries? </h2>
                    <h4 style="color: #ffffff;" class="service-heading" style="font-family: 'Questrial', sans-serif;">Please fill in any queries you have in adjacent form.</h4>
                    <h4 style="color: #ffffff;" class="service-heading" style="font-family: 'Questrial', sans-serif;">We will  get back to you as soon as possible.</h4>
                    <!-- <p style="color: #ffffff;" class="text-muted">We will  get back to you as soon as possible.</p> -->
<!--<p style="color: #ffffff;">Details:<ol style="color: #ffffff;">
                ...
                <div class="col-lg-6">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $name = $_POST['name'];
                        $email = $_POST['email'];
//mail("arpit22201@gmail.com","hello",$msg);
...
if(!$mail->send()) {
    ...
    $query = "INSERT INTO surp_2021_queries (Name, Query, Email) VALUES ('$name', '$message', '$email')";
   // $result = mysqli_query($link, $query) or die ('Error connecting to database');
   // mysqli_close($link);
$connect = mysqli_connect('remotemysql.com', 'NFQ7BMypRh', 'J1oIPYSZ1Q', 'NFQ7BMypRh' ) or die("lmao");
$output = '';
 //$query = "SELECT * FROM surp_test";
 $result = mysqli_query($connect, $query);
    ...
    echo '<p style="color: #ffffff;">Dear ' .$name .', your question will be addressed soon. <br>Kindly wait for our response through email or come back to find it answered.</p>';
                    ...
                    <form role="form" name="surp-faq" method="post" autocomplete="off">
                        <div class="row">
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
                                <button type="submit" name = "submit" class="btn btn-xl" style="background-color: #323B75;" >Submit</button>
                            </div>
                        </div>
                    </form> <?php } ?>
                </div>
    ...
    <!-- <script>
            ...
            const form = document.forms['surp-faq']
